...
from nas201_utils import get_individual_data, get_individual_hash
...
def main():
    for dataset in datasets:
        VALID_RESULT_FILE = './result/nas201/' + dataset + '/rs_improved_valid.txt'
        TEST_RESULT_FILE = './result/nas201/' + dataset + '/rs_improved_test.txt'
